...
public class Day4 {
	...
	private static Pattern GUARD_LINE = Pattern.compile(DATE_PATTERN + " Guard #(\\d+) begins shift");
	private static Pattern SLEEPS_LINE = Pattern.compile(DATE_PATTERN + " falls asleep");
	private static Pattern WAKES_LINE = Pattern.compile(DATE_PATTERN + " wakes up");
