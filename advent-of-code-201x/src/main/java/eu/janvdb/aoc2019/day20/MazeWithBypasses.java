...
import static eu.janvdb.util.Direction.EAST;
import static eu.janvdb.util.Direction.NORTH;
import static eu.janvdb.util.Direction.SOUTH;
import static eu.janvdb.util.Direction.WEST;
